...
server_IP = 'localhost'
peer_IP = 'localhost'
data_port = 12000  # this is this entity itself
ack_port = 12001  #stated in assignment) and copy pasted it in enity1 :)

peer_data_port=12003
peer_ack_port=12004
        ...
        try:
            ...
            if seq_num == expected_seq_number:
                ...
                if random.random() > packet_drop_prob:
                    ...
                    print(f"E1 : Dropped frame {seq_num} (simulated packet loss)")
